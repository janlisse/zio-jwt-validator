...
case class JwksLoadError(
    msg: String)
    extends JwtValidationError
case class JwksParsingError(
    msg: String)
    extends JwtValidationError
case class JwtParsingError(
    msg: String)
    extends JwtValidationError
...
case class ClaimValidationErrors(
    errors: NonEmptyChunk[ClaimValidationError])
    extends JwtValidationError
